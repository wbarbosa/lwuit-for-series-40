...
public class ListRendererEditor extends javax.swing.JPanel {
    private com.sun.lwuit.Component parentList;
    private EditableResources res;

    /** Creates new form ListRendererEditor */
    public ListRendererEditor(EditableResources res, com.sun.lwuit.Component parentList, String currentUI) {
        initComponents();
        try {
        ...
        for(String uiName : res.getUIResourceNames()) {
            ...
            com.sun.lwuit.util.UIBuilderOverride b = new com.sun.lwuit.util.UIBuilderOverride(null);
            if(!(b.createContainer(res, uiName) instanceof com.sun.lwuit.Form)) {
        ...
        Object r;
        if(parentList instanceof com.sun.lwuit.List) {
            r = (com.sun.lwuit.list.CellRenderer)((com.sun.lwuit.List)parentList).getRenderer();
        } else {
            r = ((com.sun.lwuit.list.ContainerList)parentList).getRenderer();
        }
        if(r instanceof com.sun.lwuit.list.GenericListCellRenderer) {
            com.sun.lwuit.list.GenericListCellRenderer g = (com.sun.lwuit.list.GenericListCellRenderer)r;
    ...
    public com.sun.lwuit.list.CellRenderer getResult() {
        if(selected.getModel().getSize() == 0) {
            if(parentList instanceof com.sun.lwuit.List) {
                return (com.sun.lwuit.list.CellRenderer)((com.sun.lwuit.List)parentList).getRenderer();
            } else {
                return ((com.sun.lwuit.list.ContainerList)parentList).getRenderer();
            }
        }
        com.sun.lwuit.util.UIBuilderOverride b = new com.sun.lwuit.util.UIBuilderOverride(null);
        com.sun.lwuit.Container selectedContainer = b.createContainer(res, (String)selected.getSelectedItem());
        switch(type.getSelectedIndex()) {
            case 0:
                return new com.sun.lwuit.list.GenericListCellRenderer(selectedContainer, b.createContainer(res, (String)selected.getSelectedItem()));
            case 1:
                return new com.sun.lwuit.list.GenericListCellRenderer(selectedContainer, b.createContainer(res, (String)unselected.getSelectedItem()));
            default:
                com.sun.lwuit.Container selectedContainerEven = b.createContainer(res, (String)selectedEven.getSelectedItem());
                com.sun.lwuit.Container unselectedContainerEven = b.createContainer(res, (String)unselectedEven.getSelectedItem());
                return new com.sun.lwuit.list.GenericListCellRenderer(selectedContainer, b.createContainer(res, (String)unselected.getSelectedItem()),
