...
public class HTMLEditor extends javax.swing.JPanel {
    private com.sun.lwuit.html.HTMLComponent htmlComponent;
    private EditableResources res;
    /** Creates new form HTMLEditor */
    public HTMLEditor(EditableResources res, String htmlText) {
        initComponents();
        this.res = res;
        htmlComponent = new com.sun.lwuit.html.HTMLComponent();
        htmlComponent.setBodyText(htmlText, "UTF-8");
        final LWUITComponentWrapper wrapper = new LWUITComponentWrapper(htmlComponent);
    ...
    class InsertImageAction extends TextAction {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if ((target != null) && (e != null)) {
                ...
                final com.sun.lwuit.Image img = res.getImage((String)jc.getSelectedItem());
