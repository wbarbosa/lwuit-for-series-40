    ...
    public String addResource(EditableResources res, ResourceEditorView view) {
        ...
        switch(type.getSelectedIndex()) {
            case IMAGE: // image
                ...
                break;
            case MULTI_IMAGE:
                ImageMultiEditor multiImageEditor = new ImageMultiEditor(res, name.getText());
                view.setSelectedResource(name.getText());
                break;
            case INDEXED_IMAGE:
                ImageIndexedEditor indexedEditor = new ImageIndexedEditor(res, name.getText(), view);
                indexedEditor.selectFile();
                view.setSelectedResource(name.getText());
                break;
            case TIMELINE:
                new TimelineEditor(res, name.getText());
                view.setSelectedResource(name.getText());
                break;
