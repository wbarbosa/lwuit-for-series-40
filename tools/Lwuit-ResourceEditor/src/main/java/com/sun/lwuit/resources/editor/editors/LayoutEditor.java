...
public class LayoutEditor extends javax.swing.JPanel {
    ...
    public LayoutEditor(com.sun.lwuit.Container parent) {
        initComponents();
        try {
        ...
        if(parent instanceof com.sun.lwuit.Form) {
            parent = ((com.sun.lwuit.Form)parent).getContentPane();
        }
        ...
        if(parent.getComponentCount() > 5) {
            ...
            if(parent.getLayout() instanceof com.sun.lwuit.layouts.BorderLayout) {
                ...
                com.sun.lwuit.layouts.BorderLayout b = (com.sun.lwuit.layouts.BorderLayout)parent.getLayout();
                initSwapCombo(b, com.sun.lwuit.layouts.BorderLayout.NORTH, swapNorth);
                initSwapCombo(b, com.sun.lwuit.layouts.BorderLayout.SOUTH, swapSouth);
                initSwapCombo(b, com.sun.lwuit.layouts.BorderLayout.EAST, swapEast);
                initSwapCombo(b, com.sun.lwuit.layouts.BorderLayout.WEST, swapWest);
                initSwapCombo(b, com.sun.lwuit.layouts.BorderLayout.CENTER, swapCenter);
                absoluteCenter.setSelected(b.isAbsoluteCenter());
                return;
            }
        }
        if(parent.getLayout() instanceof com.sun.lwuit.layouts.FlowLayout) {
            layoutCombo.setSelectedIndex(0);
            com.sun.lwuit.layouts.FlowLayout f = (com.sun.lwuit.layouts.FlowLayout)parent.getLayout();
            fillRows.setSelected(f.isFillRows());
            switch(f.getValign()) {
                case com.sun.lwuit.Component.TOP:
                    valign.setSelectedIndex(0);
                    break;
                case com.sun.lwuit.Component.CENTER:
                    valign.setSelectedIndex(1);
                    break;
                case com.sun.lwuit.Component.BOTTOM:
        ...
        if(parent.getLayout() instanceof com.sun.lwuit.layouts.BoxLayout) {
            if(((com.sun.lwuit.layouts.BoxLayout)parent.getLayout()).getAxis() == com.sun.lwuit.layouts.BoxLayout.Y_AXIS) {
        ...
        if(parent.getLayout() instanceof com.sun.lwuit.layouts.GridLayout) {
            layoutCombo.setSelectedIndex(3);
            rows.setValue(((com.sun.lwuit.layouts.GridLayout)parent.getLayout()).getRows());
            columns.setValue(((com.sun.lwuit.layouts.GridLayout)parent.getLayout()).getColumns());
        ...
        if(parent.getLayout() instanceof com.sun.lwuit.table.TableLayout) {
            ...
            rows.setValue(((com.sun.lwuit.table.TableLayout)parent.getLayout()).getRows());
            columns.setValue(((com.sun.lwuit.table.TableLayout)parent.getLayout()).getColumns());
            rows.setEnabled(true);
            columns.setEnabled(true);
            return;
        }
        if(parent.getLayout() instanceof com.sun.lwuit.layouts.LayeredLayout) {
            layoutCombo.setSelectedIndex(5);
            return;
        }
    }

    public com.sun.lwuit.layouts.Layout getResult() {
        switch(layoutCombo.getSelectedIndex()) {
            case 0:
                com.sun.lwuit.layouts.FlowLayout f = new com.sun.lwuit.layouts.FlowLayout();
                f.setFillRows(fillRows.isSelected());
                switch(valign.getSelectedIndex()) {
                    case 0:
                        f.setValign(com.sun.lwuit.Component.TOP);
                        break;
                    case 1:
                        f.setValign(com.sun.lwuit.Component.CENTER);
                        break;
                    case 2:
                        f.setValign(com.sun.lwuit.Component.BOTTOM);
                        break;
                }
                switch(align.getSelectedIndex()) {
                    case 0:
                        f.setAlign(com.sun.lwuit.Component.LEFT);
                        break;
                    case 1:
                        f.setAlign(com.sun.lwuit.Component.CENTER);
                        break;
                    case 2:
                        f.setAlign(com.sun.lwuit.Component.RIGHT);
                        break;
                }
                return f;
            case 1:
                return new com.sun.lwuit.layouts.BoxLayout(com.sun.lwuit.layouts.BoxLayout.X_AXIS);
            case 2:
                return new com.sun.lwuit.layouts.BoxLayout(com.sun.lwuit.layouts.BoxLayout.Y_AXIS);
            case 3:
                return new com.sun.lwuit.layouts.GridLayout(((Number)rows.getValue()).intValue(), ((Number)columns.getValue()).intValue());
            case 4:
                return new com.sun.lwuit.table.TableLayout(((Number)rows.getValue()).intValue(), ((Number)columns.getValue()).intValue());
            case 5:
                return new com.sun.lwuit.layouts.LayeredLayout();
            default:
                return createBorderLayout();
        }
    }

    private void defineSwap(com.sun.lwuit.layouts.BorderLayout b, String originalPos, JComboBox c) {
    ...
    private void initSwapCombo(com.sun.lwuit.layouts.BorderLayout b, String originalPos, JComboBox c) {
    ...
    private com.sun.lwuit.layouts.BorderLayout createBorderLayout() {
        com.sun.lwuit.layouts.BorderLayout b = new com.sun.lwuit.layouts.BorderLayout();
        defineSwap(b, com.sun.lwuit.layouts.BorderLayout.NORTH, swapNorth);
        defineSwap(b, com.sun.lwuit.layouts.BorderLayout.SOUTH, swapSouth);
        defineSwap(b, com.sun.lwuit.layouts.BorderLayout.EAST, swapEast);
        defineSwap(b, com.sun.lwuit.layouts.BorderLayout.WEST, swapWest);
        defineSwap(b, com.sun.lwuit.layouts.BorderLayout.CENTER, swapCenter);
