...
public class HashtableEditor extends javax.swing.JPanel {
    ...
    public HashtableEditor(EditableResources res, Object value, Object lst) {
        ...
        if(value == null) {
            ...
            if(lst != null) {
                Object r;
                if(lst instanceof com.sun.lwuit.List) {
                    r = ((com.sun.lwuit.List)lst).getRenderer();
                } else {
                    r = ((com.sun.lwuit.list.ContainerList)lst).getRenderer();
                }
    ...
    private void findComponentsOfInterest(com.sun.lwuit.Component cmp, List<String> dest) {
        ...
        if((cmp instanceof com.sun.lwuit.Label || cmp instanceof com.sun.lwuit.TextArea) && cmp.getName() != null) {
                ...
                .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    ...
                    .add(layout.createSequentialGroup()
                        .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.TRAILING)
                            .add(org.jdesktop.layout.GroupLayout.LEADING, stringTextField, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 375, Short.MAX_VALUE)
