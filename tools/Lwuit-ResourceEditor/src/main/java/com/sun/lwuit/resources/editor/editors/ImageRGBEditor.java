 ...
 * @author Shai Almog
 */
public class ImageRGBEditor extends javax.swing.JPanel {
        ...
        layout.setHorizontalGroup(
            ...
            .add(layout.createSequentialGroup()
                ...
                .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    ...
                    .add(org.jdesktop.layout.GroupLayout.TRAILING, jLabel1, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 64, Short.MAX_VALUE))
                .addContainerGap())
        );
    ...
    protected com.sun.lwuit.Image createImage(byte[] data) throws IOException {
        return com.sun.lwuit.EncodedImage.create(data);
    }
    ...
    private  static void findImageUse(String name, Vector users, EditableResources res, JLabel borderPreview) {
        ...
        com.sun.lwuit.Image resourceValue = res.getImage(name);
    ...
    private static void findImageUseImpl(com.sun.lwuit.Image resourceValue, Vector users, EditableResources res, JLabel borderPreview) {
                        ...
                        for(int i = 0 ; i < images.length ; i++) {
                            if(images[i] == resourceValue) {
                                ...
                                if(borderPreview != null && borderPreview.getIcon() == null) {
                                    ...
                                    com.sun.lwuit.Image img = com.sun.lwuit.Image.createImage(borderWidth, borderHeight);
                                    com.sun.lwuit.Label l = new com.sun.lwuit.Label("Preview");
                                    l.getStyle().setBorder(b);
                                    l.setSize(new com.sun.lwuit.geom.Dimension(borderWidth, borderHeight));
        ...
        for(String image : res.getImageResourceNames()) {
            com.sun.lwuit.Image current = res.getImage(image);
        ...
        for(String uiResource : res.getUIResourceNames()) {
            com.sun.lwuit.Container c = builder.createContainer(res, uiResource);
    ...
    private void convertToMultiImageActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_convertToMultiImageActionPerformed
        ...
        multi.setDpi(new int[] {com.sun.lwuit.Display.DENSITY_HIGH});
        multi.setInternalImages(new com.sun.lwuit.EncodedImage[] {(com.sun.lwuit.EncodedImage)renderer.getImage()});
