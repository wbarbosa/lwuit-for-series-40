...
public class PulsateEditor extends javax.swing.JPanel {
    private com.sun.lwuit.Image currentImage;
    private com.sun.lwuit.EncodedImage[] internalImages;
    private BufferedImage sourceImage;
    private com.sun.lwuit.Label previewLabel = new com.sun.lwuit.Label();
    ...
    public PulsateEditor() {
        ...
        preview.add(java.awt.BorderLayout.CENTER, new LWUITComponentWrapper(previewLabel));
    }
    ...
    private void updateTimeline() {
        ...
        currentImage = Timeline.createTimeline(dur, anim, new com.sun.lwuit.geom.Dimension(timelineWidth, timelineHeight));
    ...
    private void store(EditableResources res, com.sun.lwuit.Image img, String name) {
        int it = 1;
        String n = name;
