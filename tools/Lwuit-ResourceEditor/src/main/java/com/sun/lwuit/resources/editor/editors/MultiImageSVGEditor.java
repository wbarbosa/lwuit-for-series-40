...
public class MultiImageSVGEditor extends javax.swing.JPanel {
    ...
    private void updateSVGImage() {
        com.sun.lwuit.Image img = renderer.getImage();
        int count = 0;
    ...
    public com.sun.lwuit.Image getImage() {
        ...
        com.sun.lwuit.impl.swing.SVG s = (com.sun.lwuit.impl.swing.SVG)img.getSVGDocument();
        s.setDpis(dpis);
    ...
    private int getRowDPI(int row) {
        switch(row) {
            case 0:
                return com.sun.lwuit.Display.DENSITY_VERY_LOW;
            case 1:
                return com.sun.lwuit.Display.DENSITY_LOW;
            case 2:
                return com.sun.lwuit.Display.DENSITY_MEDIUM;
            case 3:
                return com.sun.lwuit.Display.DENSITY_HIGH;
            case 4:
                return com.sun.lwuit.Display.DENSITY_VERY_HIGH;
            default:
                return com.sun.lwuit.Display.DENSITY_HD;
        }
    }

    private int getDPIRow(int dpi) {
        switch(dpi) {
            case com.sun.lwuit.Display.DENSITY_VERY_LOW:
                return 0;
    ...
    public void setImage(com.sun.lwuit.Image img) {
        com.sun.lwuit.impl.swing.SVG s = (com.sun.lwuit.impl.swing.SVG)img.getSVGDocument();
        if(s.getDpis() != null) {
            for(int iter = 0 ; iter < dpiTable.getRowCount() ; iter++) {
    ...
    private void initComponents() {
        ...
        help.setText("<html>\r\n  <head>\r\n\r\n  </head>\r\n  <body>\r\n    <p style=\"margin-top: 0\">\r\n      \rSVG's work for supported devices as expected, however many mobile devices do not support SVG properly or support it poorly causing issues with device fragmentation. To work around this issue the resource editor can generae fallback images for the given device resolutions which will be used seamlessly by LWUIT when SVG isn't supported by the platform.\n    </p>\n    <p>\n     The image generation is seamless once you mark a resolution and type in the desired image size e.g. for an SVG icon you might want a Low resolution image to be 24x24 and a Medium resolution to be 32x32. You achieve this by checking the boxes next to Low and medium resolution and filling in 24 and 32 in the respective columns. On platforms where SVG isn't supported PNG's would load, these PNG's will not have any animation properties that the original SVG's might have had.\n    </p>\r\n  </body>\r\n</html>\r\n"); // NOI18N
        ...
        layout.setVerticalGroup(
            ...
            .add(layout.createSequentialGroup()
                ...
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    .add(preview, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 259, Short.MAX_VALUE)
                    .add(layout.createSequentialGroup()
    ...
    protected com.sun.lwuit.Image createImage(File selection) throws IOException {
        byte[] data = new byte[(int) selection.length()];
        DataInputStream di = new DataInputStream(new FileInputStream(selection));
        di.readFully(data);
        di.close();
        com.sun.lwuit.Image i = createImage(data);
        di.close();
        return i;
    }
