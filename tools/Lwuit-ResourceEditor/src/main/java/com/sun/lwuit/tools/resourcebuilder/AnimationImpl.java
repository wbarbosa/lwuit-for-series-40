...
public class AnimationImpl {
    ...
    public StaticAnimation convert() throws IOException {
        ByteArrayOutputStream byteOutput = new ByteArrayOutputStream();
        writeResource(new DataOutputStream(byteOutput));
        StaticAnimation s = StaticAnimation.createAnimation(new DataInputStream(new ByteArrayInputStream(byteOutput.toByteArray())));
        return s;
    }
