...
public class CustomComponent {
    ...
    public CustomComponent(boolean uiResource, String type) {
        ...
        cls = com.sun.lwuit.Container.class;
    }
    ...
    /**
     * @return the lwuitBaseClass
     */
    public String getLwuitBaseClass() {
        return lwuitBaseClass;
    }

    /**
     * @param lwuitBaseClass the lwuitBaseClass to set
     */
    public void setLwuitBaseClass(String lwuitBaseClass) {
        this.lwuitBaseClass = lwuitBaseClass;
    }
