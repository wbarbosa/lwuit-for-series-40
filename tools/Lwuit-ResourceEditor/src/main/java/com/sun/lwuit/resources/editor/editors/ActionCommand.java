 ...
 * @author Shai Almog
 */
public class ActionCommand extends com.sun.lwuit.Command {
    private static int commandUniqueId = 1;
    private String action;
    private boolean backCommand;
    private String argument;
    public ActionCommand(String name, com.sun.lwuit.Image icon, int id, String action, boolean backCommand, String argument) {
        super(name, icon, id);
