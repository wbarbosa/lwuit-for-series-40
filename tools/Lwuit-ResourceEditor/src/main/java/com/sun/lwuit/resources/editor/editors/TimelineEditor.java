...
import com.sun.lwuit.tools.resourcebuilder.AnimationImpl;
...
public class TimelineEditor extends javax.swing.JPanel {
    ...
    public TimelineEditor(EditableResources res, String name) {
        initComponents();
        ...
        com.sun.lwuit.animations.Timeline current = (com.sun.lwuit.animations.Timeline)res.getImage(name);
        if(current == null) {
            current = Timeline.createTimeline(3000, new AnimationObject[0], new com.sun.lwuit.geom.Dimension(100, 100));
        }
        setImage(current);
    ...
    public class AnimationObjectTableModel extends AbstractTableModel {
        private List<com.sun.lwuit.animations.AnimationObject> anims = new ArrayList<com.sun.lwuit.animations.AnimationObject>();
        private final String[] COLUMNS = {"Start Time", "Duration", "Image", "X", "Y", "Width", "Height", "Orientation", "Opacity"};

        public int indexOf(com.sun.lwuit.animations.AnimationObject o) {
            return anims.indexOf(o);
        }

        public void setElementAt(com.sun.lwuit.animations.AnimationObject o, int index) {
            anims.set(index, o);
            fireTableRowsUpdated(index, index);
        }

        public void addElement(com.sun.lwuit.animations.AnimationObject o) {
            anims.add(o);
        ...
        public void updateTimeline(com.sun.lwuit.animations.Timeline t) {
            anims.clear();
        ...
        public com.sun.lwuit.animations.AnimationObject getElementAt(int i) {
            return anims.get(i);
        }
        ...
        private String motionToString(com.sun.lwuit.animations.Motion m) {
            if(m == null) {
                return "";
            }
        ...
        public Object getValueAt(int rowIndex, int columnIndex) {
            com.sun.lwuit.animations.AnimationObject o = anims.get(rowIndex);
            switch(columnIndex) {
                case 0:
    ...
    public static void selectFile(ResourceEditorView view, EditableResources res, String timelineName) {
        ...
        if(files != null) {
            ...
            try {
                ...
                Timeline t = Timeline.createTimeline(currentTime, anims, new com.sun.lwuit.geom.Dimension(iReader.getWidth(0), iReader.getHeight(0)));
    ...
    public void updatePosition(int x, int y, AnimationObject o, boolean startingPoint) {
        ...
        if(ok == JOptionPane.OK_OPTION) {
            ...
            t = Timeline.createTimeline(getValue(duration), animations,
                    new com.sun.lwuit.geom.Dimension(getValue(width), getValue(height)));
            t.setPause(paused);
            t.setTime(oldTime);
            setImage(t);
        }
    ...
    public void setImage(com.sun.lwuit.animations.Timeline image) {
    ...
    private void durationStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_durationStateChanged
        ...
        if(d != ((Timeline)renderer.getImage()).getDuration()) {
            com.sun.lwuit.animations.Timeline t = cloneCurrentTimeline();
            endTime.setText("" + d);
