...
public class TableLayoutConstraintEditor extends javax.swing.JPanel {
    private static final int[] ALIGN = {-1, com.sun.lwuit.Component.LEFT,
        com.sun.lwuit.Component.CENTER, com.sun.lwuit.Component.RIGHT};
    private static final int[] VALIGN = {-1, com.sun.lwuit.Component.TOP,
        com.sun.lwuit.Component.CENTER, com.sun.lwuit.Component.BOTTOM};

    private com.sun.lwuit.table.TableLayout l;

    /** Creates new form TableLayoutConstraintEditor */
    public TableLayoutConstraintEditor(com.sun.lwuit.table.TableLayout l, com.sun.lwuit.table.TableLayout.Constraint con) {
        this.l = l;
        initComponents();
        if(con == null) {
    ...
    public com.sun.lwuit.table.TableLayout.Constraint getResult() {
        com.sun.lwuit.table.TableLayout.Constraint con = l.createConstraint(((Number)row.getValue()).intValue(), ((Number)column.getValue()).intValue());
