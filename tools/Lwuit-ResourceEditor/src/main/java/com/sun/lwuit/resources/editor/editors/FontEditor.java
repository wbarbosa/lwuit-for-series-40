...
public class FontEditor extends javax.swing.JPanel {
    ...
    public FontEditor(EditableResources resources, com.sun.lwuit.Font font, String fontName) {
    ...
    public EditorFont createFont() {
        ...
        com.sun.lwuit.Font systemFont = com.sun.lwuit.Font.createSystemFont(FONT_FACE_VALUES[systemFontFace.getSelectedIndex()],
    ...
    private void initComponents() {
        ...
        layout.setVerticalGroup(
            layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
            .add(jScrollPane3, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 398, Short.MAX_VALUE)
            .add(layout.createSequentialGroup()
                .addContainerGap()
    ...
    private class FormListener implements java.awt.event.ActionListener, javax.swing.event.ChangeListener {
        ...
        public void actionPerformed(java.awt.event.ActionEvent evt) {
            ...
            else if (evt.getSource() == systemFontFace) {
    ...
    /**
     * A label that draws the text with the font from lwuit
     */
    class FontLabel extends JLabel {
        public void paintComponent(Graphics g) {
            com.sun.lwuit.Image i = com.sun.lwuit.Image.createImage(getWidth(), getHeight());
            com.sun.lwuit.Graphics jwtG = i.getGraphics();
    ...
    public com.sun.lwuit.Font createBitmapFont() {
        ...
        com.sun.lwuit.Image bitmap = com.sun.lwuit.Image.createImage(rgb, shrunk.getWidth(), shrunk.getHeight());

        return com.sun.lwuit.Font.createBitmapFont(bitmap, offsets, widths, charsetStr);
    }
