...
public class CommandEditor extends javax.swing.JPanel {
    ...
    public CommandEditor(ActionCommand cmd, EditableResources res, String uiName, List<com.sun.lwuit.Command> commands, Properties projectGeneratorSettings) {
        this.projectGeneratorSettings = projectGeneratorSettings;
        this.uiName = uiName;
        initComponents();
        goToSource.setEnabled(projectGeneratorSettings != null);
        com.sun.lwuit.Command[] existing = new com.sun.lwuit.Command[commands.size() + 1];
        existing[0] = null;
    ...
    public ActionCommand getResult() {
        ActionCommand ac = new ActionCommand(name.getText(), (com.sun.lwuit.Image)icon.getSelectedItem(),
                ((Number)id.getValue()).intValue(), getCommandAction(), backCommand.isSelected(), commandArgument.getText());
        ac.setRolloverIcon((com.sun.lwuit.Image)rollover.getSelectedItem());
        ac.setPressedIcon((com.sun.lwuit.Image)pressed.getSelectedItem());
        ac.setDisabledIcon((com.sun.lwuit.Image)disabled.getSelectedItem());
        return ac;
    }
