...
call ant clean build -file ../../Apps/LWUITDemo/build.xml
...
call mvn install:install-file -Dfile=../../Apps/LWUITDemo/dist/LWUITDemo.jar -DgroupId=com.sun.lwuit.uidemo -DartifactId=lwuit-uidemo -Dversion=1.0 -Dpackaging=jar
