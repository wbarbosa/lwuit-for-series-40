...
/**
 * Represents an exception thrown when a method is invoked requiring a particular security mode (e.g. READ or WRITE), but the connection opened is not in the mode required. The application does pass all security checks, but the connection object is in the wrong mode.
