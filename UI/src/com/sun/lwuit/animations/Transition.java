 ...
 * can be installed on a  {@link com.sun.lwuit.Form}  object using the in/out transitions, for ease of use
 * {@link com.sun.lwuit.plaf.LookAndFeel} has support for default transitions. 
 *
 * @author Shai Almog
 */
public abstract class Transition implements Animation {
    ...
    /**
     * Invoked by {@link com.sun.lwuit.Display} to set the source and destination forms.
