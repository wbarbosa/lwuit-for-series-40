...
public final class CommonTransitions extends Transition {
    ...
    public void initTransition() {
        ...
        if(transitionType == TYPE_SLIDE_AND_FADE) {
            ...
            buffer = createMutableImage(sourcePane.getWidth(), sourcePane.getHeight());
            paint(buffer.getGraphics(), sourcePane, -sourcePane.getAbsoluteX() -sourcePane.getScrollX(), -sourcePane.getAbsoluteY() -sourcePane.getScrollY(), true);
            secondaryBuffer = createMutableImage(destPane.getWidth(), destPane.getHeight());
            paint(secondaryBuffer.getGraphics(), destPane, -destPane.getAbsoluteX() -destPane.getScrollX(), -destPane.getAbsoluteY() -destPane.getScrollY(), true);
            return;
        }
        ...
        try {
            switch (transitionType) {
                ...
                case TYPE_SLIDE_AND_FADE: {
                    ...
                    paintFastSlideAtPosition(g, slidePos, 0);
                    g.translate(0, -sourceForm.getTitleArea().getHeight());
