...
public class Spinner extends List {
    ...
    private Spinner(ListModel model, ListCellRenderer rendererInstance) {
        ...
        overlayStyle = UIManager.getInstance().getComponentStyle("SpinnerOverlay");
    ...
    public void setUIID(String id) {
        super.setUIID(id);
        overlayStyle = UIManager.getInstance().getComponentStyle(id + "Overlay");
        installDefaultPainter(overlayStyle);
    }
    ...
    public void refreshTheme() {
        super.refreshTheme();
        overlayStyle = UIManager.getInstance().getComponentStyle(getUIID() + "Overlay");
        installDefaultPainter(overlayStyle);
    }
