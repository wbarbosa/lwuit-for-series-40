...
public abstract class LookAndFeel {
    ...
    public void refreshTheme() {
        ...
        defaultTensileDrag = m.isThemeConstant("tensileDragBool", true);
        defaultTensileHighlight = m.isThemeConstant("tensileHighlightBool", false);
        tensileHighlightBottomImage = null;
        tensileHighlightTopImage = null;
        if(defaultTensileHighlight) {
            tensileHighlightBottomImage = m.getThemeImageConstant("tensileHighlightBottomImage");
            tensileHighlightTopImage = m.getThemeImageConstant("tensileHighlightTopImage");
