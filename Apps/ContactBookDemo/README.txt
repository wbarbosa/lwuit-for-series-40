...
4. Right-click on the ContactBookDemo project, select Properties > Java build path > Libraries tab, and click on Add External JARs to add ...\Nokia\Devices\Nokia_SDK_2_0_Java\plugins\lwuit\bin\sdk2.0\s40-with-themes.jar and ...\Nokia\Devices\Nokia_SDK_2_0_Java\plugins\lwuit\bin\IO\IO-MIDP.jar.
5. In the Order and export tab, ensure that S40-with-themes.jar, IO-MIDP.jar and ContactBookdemo are selected and click OK.
6. Compile the ContactBookDemo project and run it on the Series 40 Emulator.
