ContactBookDemo is a simple LWUIT app that is also created in the getting started guide. It has a simple UI and it shows contacts from your contact book by using the JSR-75 PIM API.
...
3. In the Import NetBeans Projects dialog, click Browse to select the ContactBookDemo project in:
...
4. Compile the ContactBookDemo project and run it on the Series 40 Emulator.

Building in NetBeans IDE:
=========================
1. In NetBeans IDE, open the ContactBookDemo project in:
 
...\Nokia\Devices\Nokia_SDK_2_0_Java\plugins\lwuit\examples (in the SDK installation)
or
<LWUIT for Series 40 root>\examples (in the LWUIT binary downloaded separately)

2. Make sure ContactBookDemo is set as the main project (bolded). Then right-click on the project and select Clean & Build. Then run in the Series 40 emulator.
