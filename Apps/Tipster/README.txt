...
4. Right-click on the Tipster project, select Properties > Java build path > Source tab and remove all projects except Tipster/src.
...
6. In the Order and export tab, ensure that S40-with-themes.jar, IO-MIDP.jar and Tipster are selected and click OK.
7. Compile the Tipster project and run it on the Series 40 Emulator.
