...
4. Right-click on the Makeover project, select Properties > Java build path > Source tab and remove all projects except Makeover/src.
...
6. In the Order and export tab, ensure that S40-with-themes.jar, IO-MIDP.jar and Makeover are selected and click OK.
7. Compile the Makeover project and run it on the Series 40 Emulator.
